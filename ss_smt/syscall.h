/*
 * modified syscall.h - proxy system call handler routines for SS_SMT 1.0 simulator
 *
 * This file was adapted by Ronaldo A. L. Goncalves using 
 * the original syscall.h file from SimpleScalar 3.0 Tool.
 *
 ...
 * The original syscall.h file is a part of the SimpleScalar tool suite written by
 ...
 * The original syscall.h was adapted to support the ss_smt.c version 1.0.
 ...
 *
 * $Id: syscall.h,v 1.5 1998/08/27 16:49:58 taustin Exp taustin $
 *
 * $Log: syscall.h,v $
