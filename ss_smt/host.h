/*
 * modified host.h - host-dependent definitions and interfaces 
 *                   for SS_SMT 1.0 simulator
 *
 * This file was adapted by Ronaldo A. L. Goncalves using 
 * the original host.h file from SimpleScalar 3.0 Tool.
 *
 ...
 * The original host.h file is a part of the SimpleScalar tool suite written by
 ...
 * The main adaptations were the inclusion of the definitions/variables: 
 * MAX_SLOTS, process_num, finished and exit_slot
 *
...
/* max number of slots (replicated structures). If its value is changed, then
update the "#define itoa" in misc.h file */
#ifndef MAX_SLOTS
#define MAX_SLOTS  17
#else
