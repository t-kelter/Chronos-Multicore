/*
 * modified options.h -  options package routines for SS_SMT 1.0 simulator
 *
 * This file was adapted by Ronaldo A. L. Goncalves using 
 * the original options.h file from SimpleScalar 3.0 Tool.
 *
 ...
 *
 * The original options.h file is a part of the SimpleScalar tool suite written by
 ...
 * The original option.h was adapted to support the ss_smt.c version 1.0.
 ...
 *
 * $Id: options.h,v 1.2 1998/08/27 15:48:03 taustin Exp taustin $
 *
 * $Log: options.h,v $
