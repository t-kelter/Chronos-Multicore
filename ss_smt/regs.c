/*
 * modified regs.c -  architected registers state routines for SS_SMT 1.0 simulator
 *
 * This file was adapted by Ronaldo A. L. Goncalves using 
 * the original regs.c file from SimpleScalar 3.0 Tool.
 *
 ...
 *
 * The original regs.c file is a part of the SimpleScalar tool suite written by
 ...
 * The original regs.c was adapted to support the ss_smt.c version 1.0.
 ...
 *  
 * $Id: regs.c,v 1.5 1998/08/27 15:53:09 taustin Exp taustin $
 *
 * $Log: regs.c,v $
