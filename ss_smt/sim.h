/*
 * modified sim.h -  simulator main line interfaces for SS_SMT 1.0 simulator
 *
 * This file was adapted by Ronaldo A. L. Goncalves using 
 * the original sim.h file from SimpleScalar 3.0 Tool.
 *
 ...
 *
 * The original sim.h file is a part of the SimpleScalar tool suite written by
 ...
 * The original sim.h was adapted to support the ss_smt.c version 1.0.
...
extern int sim_swap_bytes[MAX_SLOTS];
extern int sim_swap_words[MAX_SLOTS];

/* execution instruction counter */
extern counter_t sim_num_insn[MAX_SLOTS];
