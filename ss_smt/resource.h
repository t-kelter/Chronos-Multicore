/*
 * modified resource.h -  resource manager routines for SS_SMT 1.0 simulator
 *
 * This file was adapted by Ronaldo A. L. Goncalves using 
 * the original resource.h file from SimpleScalar 3.0 Tool.
 *
 ...
 *
 * The original resource.h file is a part of the SimpleScalar tool suite written by
 ...
 * The original resource.h was adapted to support the ss_smt.c version 1.0.
 ...
 *
 * $Id: resource.h,v 1.4 1998/08/27 15:54:19 taustin Exp taustin $
 *
 * $Log: resource.h,v $
...
#define MAX_INSTS_PER_CLASS	64  /* default 8 */
...
struct res_pool *res_create_pool(char *name, struct res_desc *pool, int ndesc, int sn);
